...
# ── Фон ──────────────────────────────────────────────────────────────────────
background = pygame.image.load("C:/Users/Askar/Desktop/pp2 (1)/Practice-11/Racer/img/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Askar/Desktop/pp2 (1)/Practice-11/Racer/img/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Askar/Desktop/pp2 (1)/Practice-11/Racer/img/Player.png")
        self.rect  = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        try:
            pygame.mixer.Sound("C:/Users/Askar/Desktop/pp2 (1)/Practice-11/Racer/sound/crash.wav").play()
        except Exception:
            pass
        time.sleep(1)
    ...
    if hit_coins:
        ...
        try:
            pygame.mixer.Sound("C:/Users/Askar/Desktop/pp2 (1)/Practice-11/Racer/sound/getcoin.mp3").play()
        except Exception:
            pass
